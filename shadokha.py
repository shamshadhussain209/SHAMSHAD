...
\x1b[1;94m     
\x1b[1;93m
\x1b[1;92m         Shamshad Hussain
\x1b[1;91m-----------------------------------------------
\x1b[1;97m> Author : Shamshad Hussain
\x1b[1;97m> Github : https://github.com/shamshadhussain209
\x1b[1;97m> Facebok: Shamshad Hussain
\x1b[1;97m> WhatsApp: +92 3157119642
\x1b[1;97m> Facebook: FACEBOOK UNLIMITED ACCOUNT
\x1b[1;97m> version  :v.1.7
\x1b[0;97m-------------------uh---------------------------"""
...
def menu():
    ...
    if sel in['1', '01']:
        ...
        os.system('xdg-open https://.https://www.facebook.com/shamshad.hussain.5815255?ref=share_group_link')
        menu()
    elif sel in ['3', '03']:
        os.system('xdg-open https:/03157119642/C4EokyLxEaZGBlyJ99M3pA')
        menu()
    else:
...
class create:
    ...
    def start(self):
        ...
        print (47*'-')
        print ('\033[1;32mTotal ids > Ok/' +str(len(ok)) + ' COULD/' + str(len(cp)))
        print (47*'-')
        input('back')
        menu()
menu()